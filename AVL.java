...
/**
 * This is a generic AVL class
 * - it has a default constructor AVL<E>();
 * - it has a constructor AVL<E>(E[] Collection);
 *
 * @author Evelyn Wu
 * @version 12/03/2019
 *
...
public class AVL<E extends Comparable<E>> extends Object implements Iterable<E>, Cloneable {
	...
	/**
	 * Default constructor of an AVL object
	 */
	public AVL() {
		root = null;
		size = 0;
	...
	/**
	 * Consructs a new AVL object stores the elements in a collection
	...
	/**
	 * get the first Node of this AVL object
	...
	/**
	 * Return the height difference of the subtrees of a given node
	 * @param node - node to find out its balancefactor
	 * @return balance factor ( the height difference of the subtrees of a given node)
	 */
	...
	/**
	 * balance a tree which its left subtree has two more levels than its right tree
	 * @param A - node to be balanced
	...
	/**
	 * balance a tree which its right subtree has two more levels than its right tree
	 * @param A - node to be balanced
	 * @return the new root node
	 */
	...
	/**
	 * balance a tree which its left subtree has two more levels than its right subtree
	 * @param A - node to be balanced
	 * @return the new root node
	 */
	...
	/**
	 * balance a tree which its right subtree has two more levels than its left subtree
	 * @param A - node to be balanced
	 * @return the new root node
	 */
